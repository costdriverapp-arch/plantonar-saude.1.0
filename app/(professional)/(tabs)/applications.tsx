...
export default function ApplicationsScreen() {
  const { myApplications, cancelApplication, loadMyApplications } = useApp();
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyDesc}>Candidate-se a vagas para vê-las aqui.</Text>
          </View>
        }
        renderItem={({ item }) => {
              ...
              {item.vacancy && (
                <>
                  ...
                  <View style={styles.infoRow}>
                    ...
                    <Text style={styles.infoText}>{item.vacancy.shiftDate} • {item.vacancy.workHours}</Text>
                  </View>
                </>
              )}
...
const styles = StyleSheet.create({
  ...
  infoRow: { flexDirection: "row", gap: 6, alignItems: "center", marginBottom: 3 },
  ...
  valueLabel: { fontSize: 13, color: "#64748b" },
  value: { fontSize: 14, fontWeight: "700", color: "#16a34a" },
  cancelBtn: { flexDirection: "row", alignItems: "center", gap: 6, marginTop: 12, alignSelf: "flex-start" },
