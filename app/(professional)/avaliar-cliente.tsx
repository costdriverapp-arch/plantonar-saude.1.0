...
const MUTED = "#6b7280";
const BORDER = "#e5e7eb";
const PROFESSIONAL_PRIMARY = "#1e40af";
const STAR = "#f59e0b";
...
export default function AvaliarClienteScreen() {
  ...
  const clienteAuthUserId = String(params.clienteAuthUserId || "");
  ...
  async function handleEnviar() {
    ...
    const result = await criarReview({
      ...
      avaliadoAuthUserId: clienteAuthUserId,
      avaliadorRole: "professional",
      avaliadoRole: "client",
      nota,
  ...
  return (
    <View style={styles.container}>
      <AppHeader title="Avaliar cliente" showBack />
      ...
      >
        <View style={styles.profileCard}>
          <View style={styles.profileRow}>
            ...
            <View style={styles.profileTextArea}>
              <Text style={styles.profileName}>{getFirstName(clienteNome)}</Text>
              ...
              <View style={styles.infoRow}>
                <Feather name="check-circle" size={14} color={PROFESSIONAL_PRIMARY} />
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.sectionDescription}>
            Escolha de 1 a 5 estrelas para avaliar este cliente.
          </Text>
