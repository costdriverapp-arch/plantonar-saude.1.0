...
export default function AvaliacoesProfissionalScreen() {
  const insets = useSafeAreaInsets();
  const params = useLocalSearchParams();

  const profissionalId = String(params.profissionalId || "");
  ...
  useEffect(() => {
    ...
    async function carregar() {
      ...
      const [reviewsRes, statsRes] = await Promise.all([
        getReviewsRecebidas(profissionalId),
        getReviewStats(profissionalId),
      ]);
  ...
  return (
    <View style={styles.container}>
      <AppHeader title="Avaliações do profissional" showBack />
